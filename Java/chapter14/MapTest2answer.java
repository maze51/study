...
class Phone implements Serializable {
	private static final long serialVersionUID = 2719324105361248154L;
	private String name;
...
public class MapTest2answer {
	private HashMap<String, Phone> phoneBookMap;
	private Scanner sc;
	private String fileName = "d:/D_Other/phoneBook.dat";
	private boolean dataChange = false; // 데이터의 변경 여부를 나타내는 변수(변경되면 true)

	public MapTest2answer() {
	...
	public void phoneBookStart(){
		...
		while(true){
			...
			case 0: // 종료
				if(dataChange==true){
					System.out.println("변경된 내용을 저장합니다.");	// 추가한다면? 변경된 내용을 저장하시겠습니까? 입력받아서 처리
					save();
				}
	...
	public HashMap<String, Phone> load(){
		HashMap<String, Phone> pMap = null; // 읽어온 데이터를 저장할 Map
	...
	public static void main(String[] args) {
		new MapTest2answer().phoneBookStart();
	}
